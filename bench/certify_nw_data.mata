...
//---------------------------------------------- add_node()
// with some initial network (and thus after running prepare())
foo = nw_data_chk()
foo.N_nodes(1,5)
foo.tdim(2)
foo.weighted(0)
...
foo.add_node(1)
foo.setup()
assert(foo.schedule(1)==(1..6))
foo.copy_nodes(1,2)
foo.add_node(2)
assert(foo.schedule(1)==(1..6))
assert(foo.schedule(2)==(1..7))

// without initial network
foo = nw_data_chk()
foo.N_nodes(1,5)
foo.tdim(2)
foo.weighted(0)
...
foo.setup()
foo.copy_nw(1,2)
assert(foo.schedule(2)==(2..5))
assert(foo.chk_dropped_nodes(2)==1)
assert(foo.N_nodes(2)==4)
foo.return_node(2,1)
assert(foo.schedule(2)==(2..5,1))
assert(foo.chk_dropped_nodes(2)==J(1,0,.))
assert(foo.N_nodes(2)==5)
...
assert(foo.N_nodes(2)==5)
foo.add_node(2)
assert(foo.schedule(2)==(1..6))
assert(foo.chk_dropped_nodes(2)==J(1,0,.))
assert(foo.N_nodes(2)==6)
...
assert(foo.edge_exists(2,1,1)==1)
assert(foo.edge_exists(1,3,1)==1)
assert(foo.edge_exists(3,1,1)==1)
assert(foo.edge_exists(4,5,1)==1)
assert(foo.edge_exists(5,4,1)==1)
assert(foo.edge_exists(1,4,1)==0)
assert(foo.edge_exists(4,1,1)==0)
assert(foo.edge_exists(1,5,1)==0)
assert(foo.edge_exists(5,1,1)==0)
assert(foo.edge_exists(2,3,1)==0)
assert(foo.edge_exists(3,2,1)==0)
assert(foo.edge_exists(2,4,1)==0)
assert(foo.edge_exists(4,2,1)==0)
assert(foo.edge_exists(2,5,1)==0)
assert(foo.edge_exists(5,2,1)==0)
assert(foo.edge_exists(3,4,1)==0)
assert(foo.edge_exists(4,3,1)==0)
assert(foo.edge_exists(3,5,1)==0)
assert(foo.edge_exists(5,3,1)==0)
assert(foo.neighbours(1,1)==(2,3))
assert(foo.neighbours(2,1)==1)
assert(foo.neighbours(3,1)==1)
assert(foo.neighbours(4,1)==5)
assert(foo.neighbours(5,1)==4)
assert(foo.N_edges(1)==6)
assert(foo.weight(1,2,1)==1)
assert(foo.weight(2,1,1)==1)
assert(foo.weight(1,3,1)==1)
assert(foo.weight(3,1,1)==1)
assert(foo.weight(4,5,1)==1)
assert(foo.weight(5,4,1)==1)
assert(foo.weight(1,4,1)==0)
assert(foo.weight(4,1,1)==0)
assert(foo.weight(1,5,1)==0)
assert(foo.weight(5,1,1)==0)
assert(foo.weight(2,3,1)==0)
assert(foo.weight(3,2,1)==0)
assert(foo.weight(2,4,1)==0)
assert(foo.weight(4,2,1)==0)
assert(foo.weight(2,5,1)==0)
assert(foo.weight(5,2,1)==0)
assert(foo.weight(3,4,1)==0)
assert(foo.weight(4,3,1)==0)
assert(foo.weight(3,5,1)==0)
assert(foo.weight(5,3,1)==0)
assert(foo.schedule(1)==(1..5))
assert(foo.nodes(1)==(1..5))
assert(foo.maxnodes()==5)
...
assert(foo.edge_exists(1,3,1)==1)
assert(foo.edge_exists(3,1,1)==0)
assert(foo.edge_exists(4,5,1)==1)
assert(foo.edge_exists(5,4,1)==0)
assert(foo.edge_exists(1,4,1)==0)
assert(foo.edge_exists(4,1,1)==0)
assert(foo.edge_exists(1,5,1)==0)
assert(foo.edge_exists(5,1,1)==0)
...
assert(foo.neighbours(4,1)==5)
assert(foo.neighbours(5,1)==J(1,0,.))
assert(foo.N_edges(1)==3)
assert(foo.weight(1,2,1)==1)
assert(foo.weight(2,1,1)==0)
assert(foo.weight(1,3,1)==1)
assert(foo.weight(3,1,1)==0)
assert(foo.weight(4,5,1)==1)
assert(foo.weight(5,4,1)==0)
assert(foo.weight(1,4,1)==0)
assert(foo.weight(4,1,1)==0)
assert(foo.weight(1,5,1)==0)
assert(foo.weight(5,1,1)==0)
...
assert(foo.neighbours(5,1)==4)
assert(foo.N_edges(1)==6)
assert(foo.weight(1,2,1)==2)
assert(foo.weight(2,1,1)==2)
assert(foo.weight(1,3,1)==3)
assert(foo.weight(3,1,1)==3)
assert(foo.weight(4,5,1)==4)
assert(foo.weight(5,4,1)==4)
assert(foo.weight(1,4,1)==0)
assert(foo.weight(4,1,1)==0)
assert(foo.weight(1,5,1)==0)
assert(foo.weight(5,1,1)==0)
